  ...
  const heroVideos = [
    {
      ...
      alt: "도심 야간을 주행하는 MOPEZ 라이더",
      preload: "metadata" as const,
      label: "City-01 · NightRide",
    },
    {
      id: "trail-dawn",
      src: `${assetPrefix}/img/hero_main_2.mp4`,
      type: "video/mp4",
      sources: [
        {
          src: `${assetPrefix}/img/hero_main_2.webm`,
          type: "video/webm",
        },
      ],
      poster: presets[1].heroImage,
      alt: "햇살이 비치는 공원을 달리는 MOPEZ 라이더",
      preload: "metadata" as const,
      label: "Trail-02 · DawnRide",
    },
    {
      id: "studio-glow",
      src: `${assetPrefix}/img/hero_main_3.mp4`,
      type: "video/mp4",
      sources: [
        {
          src: `${assetPrefix}/img/hero_main_3.webm`,
          type: "video/webm",
        },
      ],
      poster: presets[2].heroImage,
      alt: "네온 조명이 감도는 밤거리를 주행하는 MOPEZ 라이더",
      preload: "metadata" as const,
      label: "Studio-03 · NightGlow",
    },
  ];
      ...
      <main className="mx-auto mt-4 flex max-w-6xl flex-col gap-20 px-5 pb-24">
        <section className="space-y-10">
          <SectionHeading
            eyebrow="Presets"
            title="추천 프리셋 3선"
            description="라이딩 프리셋을 미리 경험하세요. 선택은 간결하게, 주행은 대담하게."
          />
        ...
        <section className="space-y-10">
          <SectionHeading
            eyebrow="Journal"
            title="최근 저널 하이라이트"
            description="새로운 프리셋과 촬영 비하인드를 소개합니다."
          />
